...
obj = {
    ...
    find: function () {
        $("#table").datagrid('load', {
            projectTypeName: $("#nameSearch").val()
        })
    ...
    edit: function (id) {
        ...
        $.ajax({
            url: '/ky-ykt/projectTypeParent/select',
            type: 'get',
            dataType: 'json',
            data: {id: id},
    ...
    sum: function () {
        $("#addForm").form('submit', {
            url: "/ky-ykt/projectTypeParent/saveOrUpdate",
            method: "post",
            onSubmit: function () {
        ...
        if (rows.length > 0) {
            $.messager.confirm('确定删除', '你确定要删除你选择的记录吗？', function (flg) {
                if (flg) {
                    ...
                    $.ajax({
                        type: 'get',
                        url: "/ky-ykt/projectTypeParent/deleteMoney",
                        data: {
                            ids: ids.join(',')
                        },
                        beforesend: function () {
    ...
    delOne: function (id) {
        $.messager.confirm('提示信息', '是否删除所选择记录', function (flg) {
            if (flg) {
                $.ajax({
                    type: 'get',
                    url: '/ky-ykt/projectTypeParent/deleteOne',
                    data: {
                        id: id
                    },
                    beforesend: function () {
...
$("#table").datagrid({
    title: "数据列表",
    iconCls: "icon-left02",
    url: '/ky-ykt/projectTypeParent/queryPage',
    fitColumns: true,
    striped: true,
    method: "GET",
    pagination: true,
