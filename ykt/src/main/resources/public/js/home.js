...
$(function () {
    ...
    //$("#ddddd").html(template($("#toDoTemplate").html(), {list: menuEntities}));
});

function changeTabs(name, href) {
    var con = '<iframe scrolling="no" frameborder="0"  src="' + href + '" style="width:100%;height:100%;">';
    if ($('#con').tabs('exists', name)) {
        $('#con').tabs('select', name);
